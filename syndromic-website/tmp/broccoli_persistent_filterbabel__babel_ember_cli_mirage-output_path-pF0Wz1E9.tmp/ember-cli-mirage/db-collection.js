  ...
  class DbCollection {
    ...
    insert(data) {
      if (!Array.isArray(data)) {
        ...
        let sorted = (0, _sortBy2.default)(data, 'id');
        return (0, _map2.default)(sorted, x => this._insertRecord(x));
      }
    }
    ...
    firstOrCreate(query, attributesForCreate = {}) {
      ...
      if (record) {
        ...
        let mergedAttributes = (0, _assign2.default)(attributesForCreate, query);
    ...
    update(target, attrs) {
      ...
      if (typeof attrs === 'undefined') {
        ...
        this._records.forEach(record => {
          let oldRecord = (0, _assign2.default)({}, record);
